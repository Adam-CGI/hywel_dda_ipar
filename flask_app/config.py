"""
Configuration module for Hywel Dda IPAR Document Intelligence
...
# Branding (exposed to templates via context processor)
...
COSMOS_COLL_QUERIES = os.getenv("COSMOS_COLL_QUERIES", "queries")
